...
public class PCChessBoard extends ChessBoard{
    ...
    public void WinEvent(int winner)
    {
        ...
        if(winner == Chess.WHITE) {
            ...
            mb.getSituation1().setText("    准备。。。");
            mb.getSituation2().setText("    准备。。。");
        ...
        if(clickable==MainBoard.CAN_CLICK_INFO) {
            ...
            if (chessX < 524 && chessX > 50 && chessY < 523 && chessY > 50) {
                ...
                if (chess[x1][y1] == Chess.BLANK){
                    ...
                    mb.getSituation1().setText("     轮到你啦！");
                    mb.getSituation2().setText("    等待对手下棋中");
                    logger2.info("等待对方消息");
                    ...
                    if(result!=GAME_OVER) {
                        ...
                        mb.getSituation1().setText("    等待对手下棋中");
                        logger2.info("等待对方消息");
                        mb.getSituation2().setText("     轮到你啦！");
