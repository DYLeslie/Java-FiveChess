...
public class ChessBoard extends JPanel implements MouseMotionListener,MouseListener{
    ...
    ChessBoard() {
    	//加载棋盘、黑棋、白棋、位置、背景图片
        chessBoardImage = Toolkit.getDefaultToolkit().getImage("FiveChess/src/com/fivechess/view/chessBoard.jpg");
        whiteChess = Toolkit.getDefaultToolkit().getImage("FiveChess/src/com/fivechess/view/white.png");
        blackChess=Toolkit.getDefaultToolkit().getImage("FiveChess/src/com/fivechess/view/black.png");
        position=Toolkit.getDefaultToolkit().getImage("FiveChess/src/com/fivechess/view/position.gif");
